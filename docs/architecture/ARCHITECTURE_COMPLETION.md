...
- adversarial JDBC transaction-failure coverage proving both full rollback after a late pre-commit SQL failure and exact idempotent recovery after post-commit acknowledgement loss across Coin and multi-authority item-delivery state;
